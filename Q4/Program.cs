...
// Semaphore can also be used for inter-process synchronization
// Example of shared Semaphore across processes:
//     var semaphore = new Semaphore(initialCount: 3, maximumCount: 3, name: "Q4_Semaphore");
